      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 pt-20 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-16 mb-16">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-xl font-headline font-bold text-[#268bff] mb-6 tracking-wide">Pages</h3>
          ...
          <div className="col-span-1 md:col-span-3">
            <h3 className="text-xl font-headline font-bold text-[#268bff] mb-6 tracking-wide">Our Work</h3>
            <ul className="space-y-4">
              <li><Link href="/teachers" className="text-gray-700 hover:text-[#268bff] transition-colors font-semibold">Teachers</Link></li>
              <li><Link href="/parents" className="text-gray-700 hover:text-[#268bff] transition-colors font-semibold">Parents</Link></li>
              <li><Link href="/children" className="text-gray-700 hover:text-[#268bff] transition-colors font-semibold">Children</Link></li>
            </ul>
          </div>

          {/* Contact */}
          <div className="col-span-1 md:col-span-3">
            <h3 className="text-xl font-headline font-bold text-[#268bff] mb-6 tracking-wide">Contact</h3>
            <ul className="space-y-5 mb-8">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:kirti@vetaas.in" className="text-gray-700 hover:text-[#111827] transition-colors font-semibold break-all">
                  kirti@vetaas.in
                </a>
              </li>
              <li className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="w-10 h-10 rounded-full bg-black/10 flex items-center justify-center text-[#111827] hover:text-white hover:bg-[#ffc107] transition-colors"
              >
        ...
        <div className="pt-8 border-t border-black/10 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-500 font-medium">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/terms" className="hover:text-[#268bff] transition-colors">Terms of Service</Link>
          </div>
          <p>Bangalore, India 🇮🇳</p>
        </div>
